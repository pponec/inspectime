 ...
 * @author Ponec
 */
public interface ReportEventService extends AbstractService<Event> {
    
    /** Returns data for a report */
    public ReportData getReportData(ReportRequest type, Date dateFrom, Date dateTo, Long userId);
