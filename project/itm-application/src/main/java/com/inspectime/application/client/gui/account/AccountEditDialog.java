 ...
 * @author Ponec
 */
public class AccountEditDialog<CUJO extends CAccount> extends AbstractEditDialog<CUJO> {

    @Override
    public CUJO createItem() {
        return (CUJO) new CAccount();
    }
    ...
    protected void onCreateWidgets(Element parent, int pos) {
        ...
        setClosable(true);
        setModal(true);
        setHeading(newState ? "New Account" : "Edit Account");
        setWidth(500);
        setHeight(350);
        ...
        createWidget(CAccount.name);
        createWidget(CAccount.description);
        createWidget(CAccount.privateState);
        createWidget(CAccount.graphColor);
