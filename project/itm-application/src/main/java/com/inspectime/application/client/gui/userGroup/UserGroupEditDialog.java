 ...
 * @author Ponec
 */
public class UserGroupEditDialog<CUJO extends CUserGroup> extends AbstractEditDialog<CUJO> {

    @Override
    public CUJO createItem() {
        return (CUJO) new CUserGroup();
    }
    ...
    protected void onCreateWidgets(Element parent, int pos) {
        ...
        setClosable(true);
        setModal(true);
        setHeading(newState ? "New User Group" : "Edit User Group");
        setWidth(500);
        setHeight(350);
        ...
        createWidget(CUserGroup.name);
        createWidget(CUserGroup.description);
